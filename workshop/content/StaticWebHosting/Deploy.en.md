...
1. Underneath **Deploy** choose **Get Started**
{{% notice note %}}
Depending on your console and account settings, you may not see the **Deploy** prompt. In this case, choose **Connect App**.
{{% /notice %}}
